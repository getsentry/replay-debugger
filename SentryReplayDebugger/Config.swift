...
enum Config {
    static var sentryDSN: String {
        ...
        NSLog("⚠️ SENTRY_DSN not configured. Sentry will not track errors.")
        NSLog("   For CI/release builds: set SENTRY_DSN in your build environment.")
        NSLog("   For local development: Edit Scheme > Run > Arguments > Environment Variables.")
        return ""
    }
